	...
	<div class="full-item-container">
		...
		<div class="item-buttons form-actions">
			...
			<?php elseif ($extension_data->fields->get('29')) : ?>
				...
				<button class="install btn btn-success" id="appssubmitbutton" onclick="return Joomla.installfromwebexternal('<?php echo $extension_data->fields->get('29'); ?>');" type="submit"><span class="icon-pencil"></span> <?php echo JText::_('COM_APPS_INSTALL_REGISTER_DOWNLOAD_EXTERNAL') . "&hellip;"; ?></button>
				<?php elseif ($extension_data->type == 3 || (strtolower($extension_data->fields->get('50')) != "non-commercial")): ?>
				<button class="install btn btn-success" id="appssubmitbutton" onclick="return Joomla.installfromwebexternal('<?php echo $extension_data->fields->get('29'); ?>');" type="submit"><span class="icon-cart"></span> <?php echo JText::_('COM_APPS_INSTALL_PURCHASE_EXTERNAL') . "&hellip;"; ?></button>
				<?php endif; ?>&nbsp;&nbsp;&nbsp;
			<?php endif; ?>
