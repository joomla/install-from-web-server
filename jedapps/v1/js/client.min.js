...
Joomla.loadweb=function(a){if(""==a)return!1;var b=/^index.php/;if(!RegExp(apps_base_url).test(a)&&!b.test(a))return window.open(a,"_blank"),!1;a+="&product="+apps_product+"&release="+apps_release+"&dev_level="+apps_dev_level+"&list="+(Joomla.apps.list?"list":"grid");b=Joomla.apps.ordering;""!==b&&jQuery("#com-apps-ordering").val()&&(b=jQuery("#com-apps-ordering").val(),a+="&ordering="+b);jQuery("html, body").animate({scrollTop:0},0);jQuery("#myTabContent").length&&(jQuery("#appsloading").css("top",
...
Joomla.apps.clicker=function(){jQuery(".grid-view").live("click",function(){Joomla.apps.list=0;jQuery(".list-container").addClass("hidden");jQuery(".grid-container").removeClass("hidden");jQuery("#btn-list-view").removeClass("active");jQuery("#btn-grid-view").addClass("active")});jQuery(".list-view").live("click",function(){Joomla.apps.list=1;jQuery(".grid-container").addClass("hidden");jQuery(".list-container").removeClass("hidden");jQuery("#btn-grid-view").removeClass("active");jQuery("#btn-list-view").addClass("active")})};
